class Solution {
    ...
    private int calculateDays(int lwc, int[] weights){
        ...
        // if a weight up[on adding is bvelow or equal to LWC, ship it same day
        // otherwise, incease day count by 1 and start shipping from that package from next day
        // This method makes trhe total TC to O(n*logm) but SC is O(1)
